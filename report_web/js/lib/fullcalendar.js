...
var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
	...
	renderNumberCellHtml: function(date) {
		...
		if (showNumbers) {//月视图天数数字显示
			var solarMonth = date._d.getMonth()+1;//阳历月
			var solarDay = date._d.getDate();//阳历日
			var solarMonDay = solarMonth + '月' + solarDay + '日';
			var cnMonth = CnMonthofDate(date._d);//农历月
			var cnDay = CnDayofDate(date._d);//农历日
			var solar = SolarTerm(date._d);//农历节气
			...
			//渲染阳历节日
			switch(solarMonDay){
				case '1月1日': cnDay = '元旦';break;
				case '2月14日': cnDay = '情人节';break;
				case '3月8日': cnDay = '妇女节';break;
				case '3月12日': cnDay = '植树节';break;
				case '4月1日': cnDay = '愚人节';break;
				case '5月1日': cnDay = '劳动节';break;
				case '5月4日': cnDay = '青年节';break;
				case '6月1日': cnDay = '儿童节';break;
				case '7月1日': cnDay = '建党节';break;
				case '8月1日': cnDay = '建军节';break;
				case '9月10日': cnDay = '教师节';break;
				case '10月1日': cnDay = '国庆节';break;
				case '10月31日': cnDay = '万圣节';break;
				case '12月24日': cnDay = '平安夜';break;
				case '12月25日': cnDay = '圣诞节';break;
			}
			
			//渲染农历节日
			switch(cnMonDay){
				case '正月初一': cnDay = '春节';break;
				case '正月十五': cnDay = '元宵';break;
				case '五月初五': cnDay = '端午';break;
				case '七月初七': cnDay = '七夕';break;
				case '七月十五': cnDay = '中元';break;
				case '八月十五': cnDay = '中秋';break;
				case '九月初九': cnDay = '重阳';break;
				case '腊月初八': cnDay = '腊八';break;
				case '腊月三十': cnDay = '除夕';break;
			}
		...
		return '' +
			'<td class="' + classes.join(' ') + '" data-date="' + date.format() + '"><span style="display:inline-block;float:left;margin-left:5px;">'+cnDay+'</span>' +
			date.date() +
			'</td>';
